...
/* Las fotos se IMPORTAN en vez de ir como ruta de texto: así el build las
   procesa —webp y varios anchos— y <Image> puede generar el srcset. Las
   texturas de la isla no van por aquí: esas las carga three.js en runtime
   desde public/ y tienen que quedarse crudas. */
import foto_m_origen from '../assets/img/photos/m-origen.jpg';
import foto_g_archivo from '../assets/img/photos/g-archivo.jpg';
import foto_g_estudio from '../assets/img/photos/g-estudio.jpg';
import foto_m_nebula from '../assets/img/photos/m-nebula.jpg';
